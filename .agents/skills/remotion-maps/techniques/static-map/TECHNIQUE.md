...
Follow [Remotion Interactivity](../../../remotion-interactivity/linked.skill.md) best practices and [Remotion Markup Best practices](../../../remotion-markup/linked.skill.md) for elements.
